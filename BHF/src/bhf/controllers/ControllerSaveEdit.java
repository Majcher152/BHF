...
public class ControllerSaveEdit {
	private ControllerDataBase spbd = new ControllerDataBase();
	
	public boolean edit(String login, String name, String lastname, String email,
			String phoneNumber, String type) {
		boolean odp = spbd.saveEdit(login, name, lastname, email, phoneNumber, type);
		return odp;
	}

	public boolean saveEdit(String login, String name, String lastname, String email,
			String phoneNumber, String type) {
		boolean odp = spbd.saveEdit(login, name, lastname, email, phoneNumber, type);
		return odp;
	}
	
	public int uwierzytelnij_edit(String imie, String nazwisko, String email, String nrTelefonu, String login) {
